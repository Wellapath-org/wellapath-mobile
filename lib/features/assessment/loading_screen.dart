...
class _LoadingScreenState extends State<LoadingScreen> {
  ...
  // Artifacts (knowledge base, rules, token dictionary) are cached in their own
  // Hive box — separate from the config cache — so they are downloaded once and
  // reused on subsequent assessments instead of re-fetched every time.
        ...
        if (artifacts is Map) {
          ...
          if (kbUrl != null && rulesUrl != null && tokenDictUrl != null) {
            ...
            final engineInput = EngineInput(
              ...
              demographicTokens: assessmentInput.demographicTokens,
            );
